var input = require("fs").readFileSync("beecrowd/ref1005.js", "utf8");
...
Utilize variáveis de dupla precisão (double) e como todos os problemas, não esqueça de 
imprimir o fim de linha após o resultado, caso contrário, você receberá "Presentation Error".*/

var a = parseFloat(lines.shift());
var b = parseFloat(lines.shift()); //ele le os numeros automaticamente
